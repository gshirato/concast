...
def add_tags(episode_number):
    ...
    mp3 = MP3(f'../episodes/{episode_number}.mp3')
    audio = ID3(f'../episodes/{episode_number}.mp3')
    df = pd.read_csv(f'markers/{episode_number}.csv', sep='\t')
